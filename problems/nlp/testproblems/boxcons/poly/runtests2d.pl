...
run_test("0.5 x^4 - 8 x^2 + 2.5 x + 0.5 y^4 - 8 y^2 + 2.5 y", 10000);
run_test("0.5 x^4 - 8 x^2 + 2.5 x + 0.5 y^4 - 8 y^2 + 2.5 y", -78.33198);

# Beale function
run_test("2 x^2 y + 3 x^2 y^2 + 3 x^2 + x^2 y^6 + x^2 y^4 - 2 x^2 y^3 - 12.75 x - 3 x y - 4.5 x y^2 + 5.25 x y^3 + 14.20312", 10000);
run_test("2 x^2 y + 3 x^2 y^2 + 3 x^2 + x^2 y^6 + x^2 y^4 - 2 x^2 y^3 - 12.75 x - 3 x y - 4.5 x y^2 + 5.25 x y^3 + 14.20312", 0);

# Zettle function
run_test("x^4 - 4 x^3 + 2 x^2 y^2 + 4 x^2 + 0.25 x - 4 x y^2 + y^4", 10000);
run_test("x^4 - 4 x^3 + 2 x^2 y^2 + 4 x^2 + 0.25 x - 4 x y^2 + y^4", -0.003791);
